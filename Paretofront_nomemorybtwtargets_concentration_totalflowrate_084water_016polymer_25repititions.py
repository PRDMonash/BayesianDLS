...
def generate_initial_data(n,target):
    ...
    print(f"your initial water flowrates are: {waterflowrate}, intital polymer flow rates are: {polymerflowrate} and your intital dilution flow rates are: {dilutionflowrate}")
     #List of according initialvolume fractions and total flow rates
    print(f"your initial concentrations are: {X1_initial} and your intital total flow rates are: {X2_initial}")
